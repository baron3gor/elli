...
function ale_init_navigation() {
	if (function_exists('register_nav_menus')) {
		register_nav_menus(array(
			'header_menu'	=> esc_html__('Header Menu', 'elli'),
			'sticky_left'	=> esc_html__('Sticky Left Menu', 'elli'),
            //'header_right_menu'	=> esc_html__('Header Right Menu', 'elli'),
            //'footer_menu'	=> esc_html__('Footer Menu', 'elli'),
            'mobile_menu'	=> esc_html__('Mobile Menu', 'elli'),
		));
	}
}
