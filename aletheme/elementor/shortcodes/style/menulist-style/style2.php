...
<div class="elli-menu-wrapper-container menu-wrapper-container-gallery<?php if($ale_gallery_al == 'left') : echo esc_attr(' left-menu-align', 'elli'); endif; ?>">
    <div class="details-content">     
        ...
        <div class="menu-list-wrapper fade-animation">
            ...
            if ($ale_menuitem->have_posts()) : while ($ale_menuitem->have_posts()) : $ale_menuitem->the_post(); 
                ...
                <div class="menu-list-item<?php if($ale_items_width == 'adapt') : echo esc_attr(' list-item-adaptgl', 'elli'); endif; ?>">
    ...
    <div class="menu-list-container">
        <div class="gallary-wrapper cf">
            ...
            <?php endif; ?>
            <?php if($ale_galleryArr != '') : ?>
                <div class="gallery-wrapper-imgs">
                    <?php foreach ( $ale_galleryArr as $image ) { ?>
