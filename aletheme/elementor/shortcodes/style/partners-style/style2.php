<div class="ale-multi-partners-wrapper fade-animation">
    <div class="ale-multi-partners">
        <?php    
        foreach($ale_part as $partner => $item) : 
            ...
            if(isset($ale_i_link) && !empty($ale_i_link)) : ?>
                <div class="partner-wrapper-item">
                    <a class="ale-partner-link-wrapper" href="<?php echo esc_url($ale_i_link, 'elli'); ?>" target="<?php echo esc_attr( $ale_i_targ ); ?>">
