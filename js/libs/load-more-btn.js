jQuery(function($){
    ...
    $.fn.ale_load_more_gl = function() {
        ...
        if(getMaxPage > 1) {
            $getContainer.after('<div class="loadmore-container"><div class="load-wrapper"><div class="loadmore_gallery fade-animation btn-style' + getStyle + '" id="true_loadmore"><span>' + aleloadmore.button_text + '</span>' + '<div class="overlay"></div>' + '</div></div></div>');
        }
                ...
                if (res.success) {  
                    ...
                    $grid.append( $content ).imagesLoaded(function(){
                        ...
                        if (getPage == getMaxPage) {
                            ...
                            getBtnContainer.html('<div class="load-wrapper"><div class="loadmore_gallery fade-animation btn-style' + getStyle + '" id="true_loadmore"><span>' + aleloadmore.button_text + '</span>' + '<div class="overlay"></div>' + '</div></div>');
